...
from estacionamento.api.views import ClienteViewSet, CarroViewSet, VagaEstacionamentoViewSet, PagamentoViewSet
...
router.register("Vaga", VagaEstacionamentoViewSet, basename="vaga")
